...
import sys
sys.path.append("D:/Kijin/dms_repository/models/trunk/input_storage/src")
...
#    Input and output ###########################################    
    ...
    processed_data_keywords=["qext","hydro_comp_point","reservoir_node_connect", \
							"node_flow_connections","reservoir_flow_connections", "stage_boundaries"]
    ...
    define_include_block("geometry", processed_data_keywords)
    ...
    grid_includes=["grid"]
    geometry_includes=["processed_data"]
    ...
    define_profile("Geometry",processed_data_keywords+geometry_includes) 
