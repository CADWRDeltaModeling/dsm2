...
TableDescription xsect_table_description(){
  ...
  const hid_t ftypes[] =  {
            H5T_NATIVE_INT,H5T_NATIVE_DOUBLE,string_type(128)
               };
...
void xsect_append_to_buffer_f(const int * a_chan_no,const double * a_dist,const  char a_file[128], int * ierror, 
              const int file_len)
{
 _TRAP_EXCEPT(*ierror,
