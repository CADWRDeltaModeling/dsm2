#ifndef output_gate_STORAGE_H__
#define output_gate_STORAGE_H__
/**
...
/** Structure representing input of type output_gate.
...
public:
  ...
  /** Data type output_gate, default constructor */  
  ...
  /** Construct a output_gate with actual data values */
  output_gate(const  char a_name[32],const  char a_gate_name[32],const  char a_device[32],const  char a_variable[16],const  char a_interval[16],const  char a_period_op[16],const  char a_file[128], bool a_used=true, int a_layer = 0) :
  ...
  /**Copy constructor) 
   */
  output_gate (const output_gate & other) :
  ...
  /** Parent object class name.
      ...
      of this class.
  */
  output_gate::identifier_type parent_identifier()  const
  {
     return output_gate::identifier_type( name,variable );
  }

  /** Return the version/layer number of the parent object */ 
  int parent_version()  const
  {
    vector<output_gate>& pbuf = HDFTableManager<output_gate>::instance().buffer();
    output_gate parent;
    parent.set_identifier(parent_identifier());
    vector<output_gate>::iterator loc = lower_bound(pbuf.begin(),
                                                pbuf.end(),
                                                parent,
                                                identifier_compare<output_gate>());
  ...
  bool operator< (const output_gate & other) const
  {
  ...
  output_gate& operator=(const output_gate& rhs)
  {
  ...
  /** Return the class name of this object (output_gate) */
...
typedef HDFTableManager<output_gate> output_gate_table;
...
*/  
FCALL void output_gate_clear_buffer_f();

/** query number of records being stored in buffer */
FCALL int output_gate_buffer_size_f();


/** append to buffer, compatible with fortran, returns new size*/
FCALL void output_gate_append_to_buffer_f(const  char a_name[32],const  char a_gate_name[32],const  char a_device[32],const  char a_variable[16],const  char a_interval[16],const  char a_period_op[16],const  char a_file[128], int * ierror, 
...
FCALL void output_gate_write_buffer_to_hdf5_f(const hid_t* file_id, int* ierror);

/** reads the table in from a file into the buffer*/
FCALL void output_gate_read_buffer_from_hdf5_f(const hid_t* file_id, int* ierror);

/** query size information about the table in hdf5
*/
FCALL void output_gate_number_rows_hdf5_f(const hid_t* file_id, hsize_t* nrecords, int* ierror);


/** get one row worth of information from the buffer */
FCALL void output_gate_query_from_buffer_f(size_t* row, 
...
/**
  ...
  */
FCALL void output_gate_prioritize_buffer_f(int* ierror);
/**
 ...
 */
FCALL void output_gate_write_buffer_to_text_f(const char* file, const bool* append, int* ierror, int filelen);
