...
public:
  ...
  channel(const int & a_chan_no,const double & a_manning,const int & a_upnode,const int & a_downnode, bool a_used=true, int a_layer = 0) :
    chan_no(a_chan_no),
    manning(a_manning),
    upnode(a_upnode),
    downnode(a_downnode),
...
FCALL void channel_append_to_buffer_f(const int * a_chan_no,const double * a_manning,const int * a_upnode,const int * a_downnode, int * ierror);
