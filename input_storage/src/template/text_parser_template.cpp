...
///////////////////
FCALL void set_active_profile_f(const char* profile_name, int profilelen)
{
...
FCALL void set_initial_context_profile_f(const char* profile_name, int profilelen)
{
  ApplicationTextReader & reader = ApplicationTextReader::instance();
  string name(profile_name,profilelen);
  if (name == "all")
...
FCALL void set_substitution_enabled_f(const bool * enabled)
{
    ApplicationTextReader & reader = ApplicationTextReader::instance();   
...
////////////////////
FCALL void process_text_substitution_f()
{
    ApplicationTextReader & reader = ApplicationTextReader::instance();
    EnvSubstitution sub;
