...
public class SalmonBasicSurvivalBehavior implements SalmonSurvivalBehavior {
	...
	public void isSurvived(Particle p) {
		...
		//TODO Use java random number here. In the code Node, random number is generated by another function don't know why???
		if (survivalProbability<Math.random())
			p.isDead = true;	
		if (DEBUG) System.out.println("id " + p.Id + "  age:"+age*24*60+ "  p.isDead "+p.isDead);
	}
