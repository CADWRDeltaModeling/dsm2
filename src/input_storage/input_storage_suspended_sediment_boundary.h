#ifndef suspended_sediment_boundary_STORAGE_H__
#define suspended_sediment_boundary_STORAGE_H__
/**
...
/** Structure representing input of type suspended_sediment_boundary.
    This class is autogenerated by a script given
    a description of the object
    \ingroup userdata
*/
class suspended_sediment_boundary
{
public:

  /** Data type suspended_sediment_boundary, default constructor */  
  ...
  /** Construct a suspended_sediment_boundary with actual data values */
  suspended_sediment_boundary(const  char a_name[32],const  char a_composition[16],const double & a_percent, bool a_used=true, int a_layer = 0) :
    percent(a_percent),
    used(a_used),
    layer(a_layer)
  {
  ...
  /**Copy constructor) 
   */
  suspended_sediment_boundary (const suspended_sediment_boundary & other) :
  ...
  /** Parent object class name.
      ...
      of this class.
  */
  suspended_sediment_boundary::identifier_type parent_identifier()  const
  {
     return suspended_sediment_boundary::identifier_type( name,composition );
  }

  /** Return the version/layer number of the parent object */ 
  int parent_version()  const
  {
    vector<suspended_sediment_boundary>& pbuf = HDFTableManager<suspended_sediment_boundary>::instance().buffer();
    suspended_sediment_boundary parent;
    parent.set_identifier(parent_identifier());
    vector<suspended_sediment_boundary>::iterator loc = lower_bound(pbuf.begin(),
                                                pbuf.end(),
                                                parent,
                                                identifier_compare<suspended_sediment_boundary>());
  ...
  bool operator< (const suspended_sediment_boundary & other) const
  {
  ...
  suspended_sediment_boundary& operator=(const suspended_sediment_boundary& rhs)
  {
  ...
  /** Return the class name of this object (suspended_sediment_boundary) */
  string objectName() const
  { 
    return "suspended_sediment_boundary"; 
  }
...
typedef HDFTableManager<suspended_sediment_boundary> suspended_sediment_boundary_table;
...
*/  
FCALL void suspended_sediment_boundary_clear_buffer_f();

/** query number of records being stored in buffer */
FCALL int suspended_sediment_boundary_buffer_size_f();


/** append to buffer, compatible with fortran, returns new size*/
FCALL void suspended_sediment_boundary_append_to_buffer_f(const  char a_name[32],const  char a_composition[16],const double * a_percent, int * ierror, 
              const int name_len,const int composition_len);
  
/** both makes the table and writes the contents of the buffer to it */
FCALL void suspended_sediment_boundary_write_buffer_to_hdf5_f(const hid_t* file_id, int* ierror);

/** reads the table in from a file into the buffer*/
FCALL void suspended_sediment_boundary_read_buffer_from_hdf5_f(const hid_t* file_id, int* ierror);

/** query size information about the table in hdf5
*/
FCALL void suspended_sediment_boundary_number_rows_hdf5_f(const hid_t* file_id, hsize_t* nrecords, int* ierror);


/** get one row worth of information from the buffer */
FCALL void suspended_sediment_boundary_query_from_buffer_f(size_t* row, 
                         char a_name[32], char a_composition[16],double * a_percent, int * ierror, 
              int name_len,int composition_len);
/**
  prioritize buffer by layers, delete unused items and sort
  */
FCALL void suspended_sediment_boundary_prioritize_buffer_f(int* ierror);
/**
 ...
 */
FCALL void suspended_sediment_boundary_write_buffer_to_text_f(const char* file, const bool* append, int* ierror, int filelen);
