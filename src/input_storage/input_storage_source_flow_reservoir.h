#ifndef source_flow_reservoir_STORAGE_H__
#define source_flow_reservoir_STORAGE_H__
/**
...
/** Structure representing input of type source_flow_reservoir.
    This class is autogenerated by a script given
    a description of the object
    \ingroup userdata
*/
class source_flow_reservoir
{
public:

  /** Data type source_flow_reservoir, default constructor */  
  ...
  /** Construct a source_flow_reservoir with actual data values */
  source_flow_reservoir(const  char a_name[32],const  char a_res_name[32],const int & a_sign,const  char a_fillin[8],const  char a_file[128],const  char a_path[80], bool a_used=true, int a_layer = 0) :
    sign(a_sign),
    used(a_used),
    layer(a_layer)
  {
  ...
  /**Copy constructor) 
   */
  source_flow_reservoir (const source_flow_reservoir & other) :
    sign(other.sign),
    used(other.used),
    layer(other.layer)
  {
  ...
  /** Parent object class name.
      ...
      of this class.
  */
  source_flow_reservoir::identifier_type parent_identifier()  const
  {
     return source_flow_reservoir::identifier_type( name );
  }

  /** Return the version/layer number of the parent object */ 
  int parent_version()  const
  {
    vector<source_flow_reservoir>& pbuf = HDFTableManager<source_flow_reservoir>::instance().buffer();
    source_flow_reservoir parent;
    parent.set_identifier(parent_identifier());
    vector<source_flow_reservoir>::iterator loc = lower_bound(pbuf.begin(),
                                                pbuf.end(),
                                                parent,
                                                identifier_compare<source_flow_reservoir>());
  ...
  bool operator< (const source_flow_reservoir & other) const
  {
  ...
  source_flow_reservoir& operator=(const source_flow_reservoir& rhs)
  {
  ...
  /** Return the class name of this object (source_flow_reservoir) */
  string objectName() const
  { 
    return "source_flow_reservoir"; 
  }
...
typedef HDFTableManager<source_flow_reservoir> source_flow_reservoir_table;
...
*/  
FCALL void source_flow_reservoir_clear_buffer_f();

/** query number of records being stored in buffer */
FCALL int source_flow_reservoir_buffer_size_f();


/** append to buffer, compatible with fortran, returns new size*/
FCALL void source_flow_reservoir_append_to_buffer_f(const  char a_name[32],const  char a_res_name[32],const int * a_sign,const  char a_fillin[8],const  char a_file[128],const  char a_path[80], int * ierror, 
              const int name_len,const int res_name_len,const int fillin_len,const int file_len,const int path_len);
  
/** both makes the table and writes the contents of the buffer to it */
FCALL void source_flow_reservoir_write_buffer_to_hdf5_f(const hid_t* file_id, int* ierror);

/** reads the table in from a file into the buffer*/
FCALL void source_flow_reservoir_read_buffer_from_hdf5_f(const hid_t* file_id, int* ierror);

/** query size information about the table in hdf5
*/
FCALL void source_flow_reservoir_number_rows_hdf5_f(const hid_t* file_id, hsize_t* nrecords, int* ierror);


/** get one row worth of information from the buffer */
FCALL void source_flow_reservoir_query_from_buffer_f(size_t* row, 
...
/**
  ...
  */
FCALL void source_flow_reservoir_prioritize_buffer_f(int* ierror);
/**
 ...
 */
FCALL void source_flow_reservoir_write_buffer_to_text_f(const char* file, const bool* append, int* ierror, int filelen);
