c      definiation of structure for rate coefficient assignment and some 
...
c     local variables
      integer i,j,k, groupno,rate_var_id,ncc_id
	real*8 rate_value
...
c     local variables
	...
	character*32 :: ratename,constituent_name(max_constituent),name
