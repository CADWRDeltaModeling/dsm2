...
program gtm_tools
    ...
    elseif (tool_no .eq. 3) then
        ...
        arr = (/ 1037,580,583,552,541,508,1442,456,438,381,379,354,2154,2117,2108,2080,1943,1945,1893,290,392,1398,222,141,90,59,128,1364,1819,973,983,780,1617,1159,1766,124,1867,1481 /)
