...
real(gtm_real), parameter :: constant_flow  = 600.d0 ! todo 600
real(gtm_real), parameter :: constant_decay = 5.d-5   ! todo: 5.0d-5
...
real(gtm_real), parameter :: total_time = 38400.d0 ! todo 38400
real(gtm_real), parameter :: start_time = zero 
real(gtm_real), parameter :: constant_area = 1000.d0 ! todo 1000
