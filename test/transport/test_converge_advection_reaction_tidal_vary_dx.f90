...
module test_advection_reaction_tidal_vary_dx
    ...
    subroutine test_tidal_advection_reaction_vary_dx(verbose)
        ...
        tidal_hydro=> tidal_flow_modified_vary_dx ! this flow generator is mass conservative
        ! do not remove it 
        ...
        label = 'advection_tidal_gaussian_vary_dx' 

        ! load the initial values and reference final values to feed the test routine
        call initial_fine_solution_tidal_gaussian_vary_dx(fine_initial_condition, &
                                                          fine_solution,          &
                                                          nx_base,                &
                                                          nconc,                  &
                                                          origin,                 &
        ...
        label = "advection_tidal_sinusoidal_vary_dx" 
        ! load the initial values and reference final values to feed the test routine
        call initial_fine_solution_tidal_sinusoidal_vary_dx(fine_initial_condition, &
                                                            fine_solution,          &
                                                            nx_base,                &
                                                            nconc,                  &
                                                            domain_length,          &
        ...
        compute_source => tidal_reaction_source_vary_dx

        label = 'advection_reaction_tidal_gaussian_dx' 
    ...
    subroutine initial_fine_solution_tidal_gaussian_vary_dx(fine_initial_condition, &
                                                            fine_solution,          &
                                                            nx_base,                &
                                                            nconc,                  &
                                                            origin,                 &
    ...
    subroutine initial_fine_solution_tidal_sinusoidal_vary_dx(fine_initial_condition, &
                                                              fine_solution,          &
                                                              nx_base,                &
                                                              nconc,                  &
                                                              domain_length,          &
    ...
    subroutine tidal_flow_cell_average_vary_dx(flow,    &
                                               flow_lo, &
                                               flow_hi, &
                                               area,    &
                                               area_lo, &
        ...
        xpos_lo = domain_length
        xpos_hi = domain_length
        xpos = domain_length
        do icell = 1,ncell  
            ! this is L-x
            xpos_lo = xpos_hi
            xpos_hi = xpos_hi - dx(icell)
            xpos    = xpos -half*dx(icell)
 
            area(icell) = depth + (amplitude*dcos(freq*time))/(dx(icell)*big_b*dcos(big_b*domain_length)) &
    ...
    subroutine tidal_flow_modified_vary_dx(flow,     &
                                           flow_lo,  &
                                           flow_hi,  &
                                           area,     &
                                           area_lo,  &
    ...
    subroutine tidal_reaction_source_vary_dx(source,      & 
                                             conc,        &
                                             area,        &
                                             flow,        &
                                             ncell,       &
