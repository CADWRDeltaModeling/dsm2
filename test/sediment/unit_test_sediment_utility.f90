...
module test_sediment_utility
    ...
    subroutine test_explicit_particle_reynolds_number
        ...
        do i = 1, nclas
            call explicit_particle_reynolds_number(exp_re_p(i),         &
                                                   diameter(i),         &
                                                   capital_r,           &
                                                   g_acceleration,      &
                                                   kinematic_viscosity)                                       
    ...
    subroutine test_dimless_particle_diameter
        ...
        do i = 1, nclas
            call dimless_particle_diameter(d_star(i),              &
                                           g_accel,                &
                                           diameter(i),            &
                                           kinematic_viscosity,    &
                                           capital_r)                        
    ...
    subroutine test_critical_shields_parameter
        implicit none
        integer, parameter :: nclas = 6          !< Number of sediment diameter classes
        real(gtm_real):: d_star(nclas)          
        ...
        do iclas=1,nclas
            call critical_shields_parameter(cr_shields_prmtr,   &
                                            d_star(iclas))
            call assertEquals(hand_calc_value(iclas),cr_shields_prmtr,weak_eps,"Error in subroutine critical_shields_parameter!")             
        end do
        return 
    end subroutine
