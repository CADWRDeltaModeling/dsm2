...
-   Learn how HEC-DSS path names are used to reference time series in
    ...
    website: <a href="http://www.hec.usace.army.mil/software/hec-dss/hecdss-dss.html"
    rel="nofollow"
    style="text-decoration: none;">http://www.hec.usace.army.mil/software/hec-dss/hecdss-dss.html</a>   
    **dummy_res**  
...
1.  1.  Open hydro.inp. The input file uses an ENVVAR reference as the
...
1.  **Running HYDRO and QUAL**
    1.  In Windows Explorer, navigate to the directory: \_  
        ...
        1.  1.  Right-click on the directory, *t4_timevar*, and
        ...
        **Adjust DSM2MODIFIER to represent a variant scenario:**
        ...
        1.  1.  In Windows Explorer, navigate to the
        ...
        1.  **Add Time-varying Tide Information for Downstream Boundary
            in HYDRO:**
            1.  1.  Reopen i*nput_hydro_ts_tutorial.inp*
        ...
        1.  1.  Create a file for the gate input
