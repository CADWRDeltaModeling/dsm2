...
c-----read and display header info
     ...
     &     ,' n_chan',n_chan
      ...
      do extchan=1,max_channels
         if (ext2int(extchan) .ne. miss_val_i) then
            print *
     &           ,extchan
     &           ,chan_geom(extchan).bottomelev(1)
     &           ,chan_geom(extchan).bottomelev(2)
         endif
      enddo
      ...
      do i=1,nobj2obj
         ...
         print *, 'acct_name: ',obj2obj(i).from.acct_name(:5)
         ...
         print *, 'acct_name: ',obj2obj(i).to.acct_name(:5)
         print *, 'mass_frac: ',obj2obj(i).to.mass_frac

         print *
         print *, 'name: ',obj2obj(i).obj_name
         print *, 'path label: ',obj2obj(i).label
      enddo
     ...
     &        print *, i,(j,qresv(i,j),j=1,5)
      ...
      do extchan=1,max_channels
         ...
         if (intchan .ne. miss_val_i) then
            print *, extchan,
     &           ychan(intchan,1)+chan_geom(extchan).bottomelev(1),
     &           ychan(intchan,2)+chan_geom(extchan).bottomelev(2),
