...
#define sfAdd4Reservoir		 sfadd4reservoir_
...
#define sfAdd4Reservoir		__stdcall SFADD4RESERVOIR
...
void 
sfAdd4Reservoir( Template, Value1, Value2 )

long Template[4];
RealNumber *Value1;
RealNumber *Value2;
{
/* Begin `sfAdd4Reservoir'. */
    *((RealNumber *)Template[0]) += *Value1;
    *((RealNumber *)Template[1]) -= *Value1;
    *((RealNumber *)Template[2]) += *Value2;
    *((RealNumber *)Template[3]) -= *Value2;
}
