...
*== Public (InitializeRightSide) ==========================================

      LOGICAL FUNCTION InitializeRightSide()

      IMPLICIT NONE

*   Purpose:  Initialize right-hand side vector to zero.
...
*== Public (IncrementalZRes) ==============================================

      REAL*8 FUNCTION IncrementalZRes(ResNumber)

      IMPLICIT NONE

*   Purpose:  Return the incremental change in reservoir-surface elevation
*             over the last iteration.
...
*   Argument definitions:
*     LocationNumber - internal reservoir number
...
*-----Implementation -----------------------------------------------------
      ...
      IncrementalZRes = X( TotalNonResRows + ResNumber )
