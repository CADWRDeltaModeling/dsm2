...
C!    or see our home page: http://baydeltaoffice.water.ca.gov/modeling/deltamodeling/
     ...
     &     )
      ...
      structure /irreg_geom_str/
         integer chan_no        ! channel number, read from file
         ...
         character*200 filename ! cross-section data file name
...
c--------of the irreg_geom structure
      ...
      record /irreg_geom_assg_str/ irreg_geom_assg(0:max_channels)
      common /com_s_irr_assg/ irreg_geom_assg
