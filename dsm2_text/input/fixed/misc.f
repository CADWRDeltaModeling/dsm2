...
c-----I/O unit values
      integer
     &     unit_error           ! error messages
     &     ,unit_input          ! input unit
     &     ,unit_screen         ! output unit to screen
     &     ,unit_output         ! output unit to file
     &     ,unit_text           ! temporary (scratch) text file output

      parameter (
     &     unit_error=0         ! usually to screen
     &     ,unit_input=11
     &     ,unit_screen=6       ! this MUST be 6 to work properly
     &     ,unit_text=13
     &     ,unit_output=14
     &     )
...
c-----object-to-object connections
     ...
     &     ,obj2obj_acctname    ! accounting name (e.g. 'diversion', 'drainage')
...
c-----index numbers for gates
     ...
     &     ,gate_crest_elev
     &     ,gate_crest_free
     &     ,gate_coeff_weir_down
     &     ,gate_coeff_weir_up
     &     ,gate_npipes
     &     ,gate_pipe_rad
     &     ,gate_pipe_elev
     &     ,gate_coeff_pipe_down
     &     ,gate_coeff_pipe_up
     &     ,gate_oper
     &     ,gate_dhopen
     &     ,gate_velclose
     ...
     &     ,gate_crest_elev=10
     &     ,gate_crest_free=11
     &     ,gate_coeff_weir_down=12
     &     ,gate_coeff_weir_up=13
     &     ,gate_npipes=14
     &     ,gate_pipe_rad=15
     &     ,gate_pipe_elev=16
     &     ,gate_coeff_pipe_down=17
     &     ,gate_coeff_pipe_up=18
     &     ,gate_oper=19
     &     ,gate_dhopen=20
     &     ,gate_velclose=21
     &     )
...
c-----index numbers for printout
     ...
     &     ,outpath_from_node=18
     &     ,outpath_from_type=19
     &     ,outpath_fromwb=20
     &     ,outpath_towb=21
     &     )
...
c-----gate positions
      ...
      integer
     &     GATE_OPEN            ! open, use given flow coeffs and width (operational flow)
     &     ,GATE_CLOSE          ! closed (no flow)
     &     ,GATE_CALC           ! open/close calculated from delta-h and velocity
     &     ,GATE_FREE           ! open, flow coeffs==1.0, full width (free flow)
...
c     &     ,backslash='\\'      !! <UNIX> 
     ...
     &     )
      ...
      character*14 generic_dt   ! generic date/time start
      parameter (generic_dt='01JAN3001 0000')
