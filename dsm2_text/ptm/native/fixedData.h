...
extern "C" {
  ...
  */
  ...
  STDCALL getFluxIncoming(int* index,int *array);
  STDCALL getFluxOutgoing(int* index,int *array);
  STDCALL getFluxIncomingType(int* index,int *array);
  STDCALL getFluxOutgoingType(int* index,int *array);
  STDCALL getFluxIncomingAccountType(int* index,int *array);
  STDCALL getFluxOutgoingAccountType(int* index,int *array);
