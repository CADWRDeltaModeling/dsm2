...
extern "C" {
  ...
  */
  ...
  void STDCALL getFluxIncoming(int* index,int *array);
  void STDCALL getFluxOutgoing(int* index,int *array);
  void STDCALL getFluxIncomingType(int* index,int *array);
  void STDCALL getFluxOutgoingType(int* index,int *array);
  void STDCALL getFluxIncomingAccountType(int* index,int *array);
  void STDCALL getFluxOutgoingAccountType(int* index,int *array);
