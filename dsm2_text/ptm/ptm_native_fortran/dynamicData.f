...
c-------- channel flow +ve from up node to down node
         if (dsmNumber .ne. 0 .and. dsmNumber .ne. miss_val_i)then
            wb(id).flowToNode(1) = -Qchan(dsmNumber,1) !upnode flow
            wb(id).flowToNode(2) = Qchan(dsmNumber,2) !downnode flow
         end if
      enddo
...
c-----+++++++++++++++++++++++++++++++++++++++++++++++++++
      ...
      integer number
      get_up_node_depth= Ychan(number,1)
      return
      end
...
c-----+++++++++++++++++++++++++++++++++++++++++++++++++++
      ...
      integer number
      get_down_node_depth= Ychan(number,2)
      return
      end
...
c-----+++++++++++++++++++++++++++++++++++++++++++++++++++
      ...
      integer number
      get_up_node_stage= Ychan(number,1)+chan_geom(int2ext(number)).bottomelev(1)
      return
      end
...
c-----+++++++++++++++++++++++++++++++++++++++++++++++++++
      ...
      integer number
      get_down_node_stage= Ychan(number,2)+chan_geom(int2ext(number)).bottomelev(2)
      return
      end
...
c-----+++++++++++++++++++++++++++++++++++++++++++++++++++
      ...
      integer number
      get_up_node_area= Achan(number,1)
      return
      end
...
c-----+++++++++++++++++++++++++++++++++++++++++++++++++++
      ...
      integer number
      get_down_node_area= Achan(number,2)
      return
      end
