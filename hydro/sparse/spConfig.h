...
/* Eli: added these for MSVC 6*/
#pragma warning( disable : 4033 30)
#pragma warning( disable : 4244 4)
#pragma warning( disable : 4013 1)
#pragma warning( disable : 4716 2)
#pragma warning( disable : 4101 2)
...
/*
* Eli: deleted a lot of original code here.
   This code is currently deleted because most ANSI standard C compilers
 * do not provide the standard header files yet. Eli:blocked out last ifdef
 */
#   include <limits.h>
#   include <float.h>
#   define  MACHINE_RESOLUTION      2.22044049250313e-016
#   define  LARGEST_REAL            1.79769313486231e+308
#   define  SMALLEST_REAL           2.22507385850720e-308
#   define  LARGEST_SHORT_INTEGER   32766
#   define  LARGEST_LONG_INTEGER    2147483646
/*#else /* NOT defined(__STDC__) */
/* Eli: blocked out last #else
