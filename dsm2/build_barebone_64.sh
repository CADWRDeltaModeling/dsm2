...
cmake -DCMAKE_BUILD_TYPE=Release -DJAVA_HOME=/home/knam/local/jdk/jdk1.6.0_45 -DCMAKE_CXX_COMPILER="icpc" -DCMAKE_C_COMPILER="icc" -DCMAKE_Fortran_COMPILER="ifort" -DTHIRD_PARTY_DIR=/home/knam/repos/dsm2_third_party_libs/builds/intel-2020.0.2/64bit/ -DCMAKE_Fortran_FLAGS="-fpp" -G "Unix Makefiles" ../src
make -j10
