...
#define getNodesOfFilters get_nodes_of_filters_
#define getWaterbodiesOfFilters get_waterbodies_of_filters_
#define getWaterbodyTypesOfFilters get_waterbodytypes_of_filters_
