...
module netcntrl
    ...
    integer :: QuadPts
    integer :: Seconds
    integer, parameter:: MaxBndEq=2*MAX_CHANNELS
    integer, parameter:: MaxTS=10
    integer :: PrintLevel
    integer :: PrintCount
    integer :: PrintInc
    integer :: TimeSeriesCount
    integer :: TimeSeriesInc
    integer :: SpatialSeriesCount
    integer :: SpatialSeriesInc
    integer :: TSChannel(MaxTS)
    integer :: TimeSeriesLocation(MaxTS)
    integer :: TimeSeries
    integer :: BoundaryEquations
    integer, allocatable:: EqNumber(:)
    integer, parameter:: MaxComponents =5
    integer :: ChannelRatioQ
    integer :: NodeRatioQ
    integer :: ChannelChangeZ
    integer :: NodeChangeZ
    integer :: DT
    integer :: NetStartTime
    real*8 :: TSX(MaxTS)
