...
module common_xsect
    use constants
    !@# use common_vars, only: n_chan, chan_geom	@!# This is the original line, replaced by the next:
	use common_vars, only: n_chan !@# chan_geom is declared in module grid_data.
