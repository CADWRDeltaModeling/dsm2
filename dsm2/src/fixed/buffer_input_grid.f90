...
!------ Clear the xsect buffer. Why? Because we have already converted
!       the cross sections to cross-section layer format, and when we
!       write out the input buffers we don't want to include the xsects that
!       are file-based
