...
module qual_process_tide
   !! Module to process Hydro tidefile data for Qual
   use qual_param
   use bltm
   implicit none
contains
...
!-----Process Hydro tidefile data into arrays needed by Qual.
      ...
      use mod_masstrack, only: determine_mass_in_delta
      use common_qual, only: mass_tracking
      implicit none
