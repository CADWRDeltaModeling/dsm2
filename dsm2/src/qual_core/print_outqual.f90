...
!!</license>
submodule (dsm2qual) mod_print_outqual
contains
...
!-----1D Lagrangian Transport Modeling of Water Quality
...
!     Group memebers
	call WriteGroupMembers2File(unit_output, groupArray, ngroup)
...
end submodule mod_print_outqual