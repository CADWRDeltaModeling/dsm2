#ifndef gate_weir_device_STORAGE_H__
#define gate_weir_device_STORAGE_H__
/**
...
/** Structure representing input of type gate_weir_device.
    This class is autogenerated by a script given
    a description of the object
    \ingroup userdata
*/
class gate_weir_device
{
public:

  /** Data type gate_weir_device, default constructor */  
  ...
  /** Construct a gate_weir_device with actual data values */
  gate_weir_device(const  char a_gate_name[32],const  char a_device[32],const int & a_nduplicate,const double & a_width,const double & a_elev,const double & a_height,const double & a_cf_from_node,const double & a_cf_to_node,const  char a_default_op[16], bool a_used=true, int a_layer = 0) :
  ...
  /**Copy constructor) 
   */
  gate_weir_device (const gate_weir_device & other) :
  ...
  */
  ...
  bool operator< (const gate_weir_device & other) const
  {
  ...
  gate_weir_device& operator=(const gate_weir_device& rhs)
  {
  ...
  /** Return the class name of this object (gate_weir_device) */
  string objectName() const
  { 
    return "gate_weir_device"; 
  }
...
typedef HDFTableManager<gate_weir_device> gate_weir_device_table;
...
*/  
FCALL void gate_weir_device_clear_buffer_f();

/** query number of records being stored in buffer */
FCALL int gate_weir_device_buffer_size_f();


/** append to buffer, compatible with fortran, returns new size*/
FCALL void gate_weir_device_append_to_buffer_f(const  char a_gate_name[32],const  char a_device[32],const int * a_nduplicate,const double * a_width,const double * a_elev,const double * a_height,const double * a_cf_from_node,const double * a_cf_to_node,const  char a_default_op[16], int * ierror, 
              const int gate_name_len,const int device_len,const int default_op_len);
  
/** both makes the table and writes the contents of the buffer to it */
FCALL void gate_weir_device_write_buffer_to_hdf5_f(const hid_t* file_id, int* ierror);

/** reads the table in from a file into the buffer*/
FCALL void gate_weir_device_read_buffer_from_hdf5_f(const hid_t* file_id, int* ierror);

/** query size information about the table in hdf5
*/
FCALL void gate_weir_device_number_rows_hdf5_f(const hid_t* file_id, hsize_t* nrecords, int* ierror);


/** get one row worth of information from the buffer */
FCALL void gate_weir_device_query_from_buffer_f(size_t* row, 
...
/**
  ...
  */
FCALL void gate_weir_device_prioritize_buffer_f(int* ierror);
/**
 ...
 */
FCALL void gate_weir_device_write_buffer_to_text_f(const char* file, const bool* append, int* ierror, int filelen);
