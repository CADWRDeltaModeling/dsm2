...
{ 
  ...
  //Add all available item readers to map
   ...
   InputStatePtr reservoir_volPtr(new ItemInputState<reservoir_vol>());
    inputMap["RESERVOIR_VOL"] = reservoir_volPtr;
  ...
  // Include file definitions
    ...
    gridContextItems.push_back("RESERVOIR_VOL");
    ...
    hydro_time_seriesContextItems.push_back("RESERVOIR_VOL");
