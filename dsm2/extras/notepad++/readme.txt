This file contains Notepad++ language support for DSM2.
...
Either way, you should find an old one. 


**** If you have already defined a user language you will have to merge them manually ****
